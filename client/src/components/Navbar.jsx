...
const Navbar = () => {
  ...
  useEffect(() => {
    // Expecting localStorage "user" to be JSON.stringify({ name: "Ibrahim", ... })
    try {
...
navigate("/login");  };
  ...
  return (
    <header className="w-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white shadow-md">
